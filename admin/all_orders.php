...
<head>
    ...
    <title>Canteen Automation - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><b>Canteen Automation</b></span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="" alt="user"  /></a>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <footer class="footer"> © 2023 All rights reserved. Developed  by AMODK <b>Developer</a></b>  </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
