        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> Canteen Automation </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Canteen <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Choose it and Enjoy your meals! </h1>
                    <h5 class="font-white space-xs">Find the delicious food and enjoy it</h5>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose canteen</h3>
                                    <p>We have more than 100+ dishes.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Canteen Automation- The Best Food Delivery canteen</h3>
                                <p>Got Hungry? Get the food you want, from our canteen , delivered at blinking speed.
                                ...
                                <div class="social-btns">
                                    <a href="#" class="app-btn apple-button clearfix">
                                        ...
                                        <div class="pull-right"> <span class="text">Available on the</span> <span class="text-2">website</span> </div>
                                    </a>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose the canteen</a></li>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Vadgaon</a> </li>
                            <li><a href="#">Narhe</a> </li>
                            <li><a href="#">Deccan</a> </li>
                            <li><a href="#">Erandwane</a> </li>
                            <li><a href="#">Dhayri</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Karve Nagar, Pune - 600034.</p>
                            <h5>Call us at: <a href="tel:+914450005500">+91 44 50005500</a></h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Who are we?</h5>
                            <p>Launched in 2023, Our technology platform connects customers, canteen partners and delivery partners, serving their multiple needs. Customers use our platform to search and discover canteen, read and write customer generated reviews and view and upload photos, order food delivery, book a table and make payments while dining-out at restaurants.</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
