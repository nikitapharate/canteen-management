        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"><h3 style="color:white;">Canteen Automation</h3></a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="restaurants.php">Choose Canteen</a></li>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Canteen Automation - The Best Food Delivery website</h3>
                                <p>Got Hungry? Get the food you want, from the canteen , delivered at blinking speed.
                                ...
                                <div class="social-btns">
                                    <a href="#" class="app-btn apple-button clearfix">
                                        ...
                                        <div class="pull-right"> <span class="text">Available on the</span> <span class="text-2">Web Store</span> </div>
                                    </a>
