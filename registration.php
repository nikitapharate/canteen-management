         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php">  </a>Canteen AUtomation
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="phone" id="phone" pattern="[789][0-9]{9}" placeholder="Phone" > <small class="form-text text-muted">We"ll never share your email with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>What is Canteen Automation Customer Care Number?</a></h4>
                           </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                ...
                                <p>Got Hungry? Get the food you want, from canteen , delivered at blinking speed.
                                ...
                                <div class="social-btns">
                                    <a href="#" class="app-btn apple-button clearfix">
                                        ...
                                        <div class="pull-right"> <span class="text">Available on the</span> <span class="text-2">web app</span> </div>
                                    </a>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                         </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
